...
public sealed partial class InputService : Instance
{
	...
	public override void Init()
	{
		...
		if (Root != null && Root.Network != null)
		{
			...
			if (Root.Network.IsServer && !Root.Network.IsOfflineLocalSession)
			{
	...
	private bool RecomputeGameFocused()
	{
		...
		if (Root.Network.IsServer && !Root.Network.IsOfflineLocalSession) return false;
	...
	{
		if (Root != null && Root.Network.IsServer && !Root.Network.IsOfflineLocalSession) return;
